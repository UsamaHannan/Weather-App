<template>
    <v-navigation-drawer v-model="drawer" app color="white" mini-variant mini-variant-width="90">
        <v-avatar class="d-block text-center mx-auto mt-4" size="50">
        ...
        <div style="position: absolute; bottom: 20px; margin-left: auto; margin-right: auto; left:0; right:0; text-align: center;">
            <button><v-icon>fas fa-sign-out-alt</v-icon><br><span class="caption">Logout</span></button>
        </div>
    </v-navigation-drawer>
  </template>
  ...
  data: () => ({
      ...
      items: [
          ...
          {icon: 'fas fa-cloud-sun-rain', text:'Weather'},
          {icon: 'fas fa-list-ul', text:'Cities'},
